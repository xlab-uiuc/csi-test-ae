...
export HDFS_NAMENODE_USER=csiuser
export HDFS_DATANODE_USER=csiuser
export HDFS_SECONDARYNAMENODE_USER=csiuser
export YARN_RESOURCEMANAGER_USER=csiuser
export YARN_NODEMANAGER_USER=csiuser
